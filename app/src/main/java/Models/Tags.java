...
public abstract class Tags {
    ...
    public static final String UPDATE_DICTIONARY_DIALOG = "UPDATE_DICTIONARY";
    public static final String UPDATE_TOPIC_DIALOG = "UPDATE_TOPIC";
    public static final String UPDATE_WORD_DIALOG = "UPDATE_WORD";

    public static final String NEW_WORD_DIALOG = "ADD_WORD";
    ...
    public static final String LOG_TAG = " ####### LOGING";
}
